...
class IngredientAddTableViewController: UITableViewController {
    ...
    func getAutocomplete(for query: String) {
        SpoonacularAPIModel.shared.getAutocompleteIngredients(query: query, onSuccess: { (ingredients) in
 ...
 * --- SEARCH ------------------------------------------------------------------
 */
extension IngredientAddTableViewController: UISearchResultsUpdating {
